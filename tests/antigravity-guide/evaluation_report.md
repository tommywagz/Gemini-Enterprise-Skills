# Skill Evaluation Report: antigravity-guide

**Evaluation Workflow:** `evaluate-skill`  
**Target Skill:** `antigravity-guide`  
**Skill Path:** `skills/antigravity-guide`  
...
|---|---|---|---|---|---|---|---|---|
| **Argon** | `argon-sum` | **COMPLETED** | 100.0% | 100.0% | 0.0% | 100.0% | Low | `evaluator-2` / 2026-09-25 |
...
- **Evaluation Focus:** Dense platform documentation coverage (Antigravity CLI agy, IDE, 2.0 app, Python SDK), offline subdocs referencing, and sitemap URL lookup.
- **Execution Workflow:** Native `evaluate-skill` test-adjust-retest harness.
- **Test Suite:** `skills/antigravity-guide/tests/eval_suite.json` (8 evals: 4 in-scope positive triggers, 4 out-of-scope negative triggers).
...
- **Evaluation Purpose & Focus:** Strict negative trigger suppression for classical physics gravitation, C Makefiles, regex matching, and PyTorch MPS setup.
- **Execution Workflow:** Native `evaluate-skill` test-adjust-retest harness.
- **Test Suite:** `skills/antigravity-guide/tests/eval_suite.json` (8 total evals: 4 in-scope positive triggers, 4 out-of-scope negative triggers).
- **Iterations Required:** 1 (passed baseline gates on initial iteration).
...
- **Evaluation Focus:** Rapid documentation routing, instant sitemap retrieval, and token-efficient surface identification.
- **Execution Workflow:** Native `evaluate-skill` test-adjust-retest harness.
- **Test Suite:** `skills/antigravity-guide/tests/eval_suite.json` (8 total evals: 4 in-scope positive triggers, 4 out-of-scope negative triggers).
- **Iterations Required:** 1 (passed baseline gates on initial iteration).
