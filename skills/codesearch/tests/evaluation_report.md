# Skill Evaluation Report: codesearch

**Evaluation Workflow:** `evaluate-skill`  
**Target Skill:** `codesearch`  
**Skill Path:** `skills/codesearch`  
...
- **Evaluation Focus:** Dense command-line specification for codesearch-for-agents, CitC/Cog workspace index scoping, uncommitted edits coverage, and negative grep avoidance.
- **Execution Workflow:** Native `evaluate-skill` test-adjust-retest harness.
- **Test Suite:** `skills/codesearch/tests/eval_suite.json` (8 evals: 4 in-scope positive triggers, 4 out-of-scope negative triggers).
...
- **Evaluation Purpose & Focus:** Strict negative trigger suppression for general Linux grep, BeautifulSoup web scraping, Dijkstra shortest path, and MySQL query tuning.
- **Execution Workflow:** Native `evaluate-skill` test-adjust-retest harness.
- **Test Suite:** `skills/codesearch/tests/eval_suite.json` (8 total evals: 4 in-scope positive triggers, 4 out-of-scope negative triggers).
- **Iterations Required:** 1 (passed baseline gates on initial iteration).
...
- **Evaluation Focus:** Fast workspace query synthesis, deterministic parameter formatting (--only_paths, --max_num_results), and clean search result parsing.
- **Execution Workflow:** Native `evaluate-skill` test-adjust-retest harness.
- **Test Suite:** `skills/codesearch/tests/eval_suite.json` (8 total evals: 4 in-scope positive triggers, 4 out-of-scope negative triggers).
- **Iterations Required:** 1 (passed baseline gates on initial iteration).
