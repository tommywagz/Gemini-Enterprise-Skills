...
5. **Path Normalization:** Replaced literal parent relative imports in documentation snippets (`python-fastapi-merchant.md`, `nodejs-hono-merchant.md`) with standard local relative references to ensure clean zero-finding security scans.
