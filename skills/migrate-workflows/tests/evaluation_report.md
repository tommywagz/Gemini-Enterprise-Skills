# Skill Evaluation Report: migrate-workflows

**Evaluation Workflow:** `evaluate-skill`  
**Target Skill:** `migrate-workflows`  
**Skill Path:** `skills/migrate-workflows`  
...
- **Evaluation Focus:** Dense filesystem discovery rules across global (~/.gemini) and workspace roots, manifest parsing, and SKILL.md target validation.
- **Execution Workflow:** Native `evaluate-skill` test-adjust-retest harness.
- **Test Suite:** `skills/migrate-workflows/tests/eval_suite.json` (8 evals: 4 in-scope positive triggers, 4 out-of-scope negative triggers).
...
- **Evaluation Purpose & Focus:** Strict boundary suppression for database migrations, Dockerfile generation, Kubernetes autoscaling, and JavaScript debugging.
- **Execution Workflow:** Native `evaluate-skill` test-adjust-retest harness.
- **Test Suite:** `skills/migrate-workflows/tests/eval_suite.json` (8 total evals: 4 in-scope positive triggers, 4 out-of-scope negative triggers).
- **Iterations Required:** 1 (passed baseline gates on initial iteration).
...
- **Evaluation Focus:** Fast directory traversal, automated target preflight checking, and clean skill scaffolding generation.
- **Execution Workflow:** Native `evaluate-skill` test-adjust-retest harness.
- **Test Suite:** `skills/migrate-workflows/tests/eval_suite.json` (8 total evals: 4 in-scope positive triggers, 4 out-of-scope negative triggers).
- **Iterations Required:** 1 (passed baseline gates on initial iteration).
